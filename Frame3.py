...
class frame3:
    def __init__(self, master, contents):
        ...
        self.Scan_Button = Button(self.master_will_be_deleted, text=" PrintTree ", command=self.PrintTree,
                                  font="arial 15 italic", width=20)
    ...
    def PrintTree(self):
        ...
        if self.pars.check_error() == 1:
            ...
            if self.pars.start_parsing() == 1:
                ...
                tkinter.messagebox.showinfo("error", "Not Tiny")
